...
import {View, Text, Image, StyleSheet, TouchableOpacity, Animated, Linking, TouchableWithoutFeedback,ToastAndroid, Alert } from 'react-native';
...
const Header = ({navigation}) =>{
    ...
    const handleShowAlert = () => {
      Alert.alert(
        'Guest',
        "Guest doesn't have permission to change Settings",
            ...
            <Animated.View style={[styles.mmenu, { width: menuWidth }]}>
              <View style={styles.mmenutextcontainer}>
                <View style={styles.moptionsinsidemenu}>
                  ...
                  {(r=="77777777") && (<TouchableOpacity onPress={()=>{handleShowAlert()}}>
